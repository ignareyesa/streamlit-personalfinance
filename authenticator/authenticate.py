...
class Authenticate:
    ...
    def login(self, form_name: str, location: str = "main") -> tuple:
        ...
        if (not st.session_state["authentication_status"]) or (
    ...
    def username_form(self, form_name: str, location: str = "main") -> str:
        ...
        if check_username_form.form_submit_button("Enviar"):
            if len(self.username) > 0:
                ...
                raise ResetError("No se ha proporcionado un nombre de usuario")
    ...
    def _update_username(self, username: str, new_username: str):
        ...
        """
        self.credentials["usernames"][new_username] = self.credentials["usernames"][
            username
        ]
    ...
    def reset_username(self, form_name: str, location: str = "main") -> bool:
        ...
        self.username = reset_username_form.text_input(
            ...
            if self._check_credentials(inplace=False):
                if len(new_username) > 0:
                    if self.username != new_username:
                        ...
                        raise ResetError(
                            "El nombre de usuario actual y el nuevo son el mismo"
                        )
                else:
                    raise ResetError(
                        "No se ha proporcionado un nuevo nombre de usuario"
                    )
            else:
                raise CredentialsError
